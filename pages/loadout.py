...
legends = ['Ash', 'Bangalore', 'Bloodhound', 'Caustic', 'Crypto', 'Fuse', 'Gibraltar', 'Horizon', 'Lifeline', 'Loba', 'Mirage', 'Newcastle', 'Octane', 'Pathfinder', 'Rampart', 'Revenant', 'Seer', 'Valkyrie', 'Wattson', 'Wraith']
weapons = ['R-310','R-99','Alternator','RE-45','P2020','Rampage', 'Spitfire','Flatline', 'Hemlok', 'Prowler', 'C.A.R.', '30-30', 'Wingman', 'HAVOC', 'Devotion', 'L-Star', 'Triple Take', 'EVA-8', 'Mozambique', 'Peacekeeper', 'Charge Rifle', 'Longbow', 'Sentinel']
care_package = ['Volt', 'Mastiff', 'G7', 'Kraber', 'Nothing', 'Anything']
#attachments = []
